...
<main class="container mx-auto px-6 pb-10 pt-6 flex-grow">
    <div class="max-w-3xl mx-auto bg-white/85 backdrop-blur-sm border border-[#FFE1E6] rounded-3xl shadow-lg p-8">
        ...
        <p class="text-[#6B7280] mb-8">
            Přidejte nový item, který budete používat ve svých market listingech.
        </p>

        <form action="<?= BASE_URL ?>/index.php?url=item/store" method="post" class="space-y-6">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       name="name"
                       required
                       placeholder="Např. Savage Aim Materia XI"
                       class="w-full rounded-2xl bg-[#FFF5F7] border border-[#FFE1E6] px-4 py-3 text-[#1F2937] placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#FFB6C1]">
            </div>
            ...
            <div>
                ...
                <textarea id="description"
                          name="description"
                          rows="5"
                          placeholder="Krátký popis itemu..."
